...
> Note: The `@radix-ui/react-visually-hidden` package is required for improved accessibility, allowing screen readers to understand the purpose of the sidebar.
...
- [#5474](https://github.com/shadcn-ui/ui/issues/5474) - Fixed accessibility issue by adding a hidden `SheetTitle` to the Sidebar component.
